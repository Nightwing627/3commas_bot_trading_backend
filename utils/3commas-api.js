...
class threeCommasAPI {
  ...
  async accountTradeInfo(account_id) {
    return await this.makeRequest(
      "GET",
      `/public/api/ver1/bots/account_trade_info?`,
      { account_id }
    );
  }

  async botStrategyList(params) {
    return await this.makeRequest(
      "GET",
  ...
  async botCopyAndCreate(params) {
    return await this.makeRequest(
      "POST",
      `/public/api/ver1/bots/${params.bot_id}/copy_and_create?`,
      params
    );
  }
